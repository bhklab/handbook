...
Dimensionality reduction is often used as pre-processing step for subsequent analyses, including [clustering](../Clustering/index.md), [supervised learning](../../Supervised_Learning/Supervised_Learning_Algorithms.md), or visualization. Common techniques for dimensionality reduction include:
