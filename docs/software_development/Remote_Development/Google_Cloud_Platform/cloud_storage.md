...
Google Cloud Storage (GCS) is a scalable and secure object storage for data files, datasets, and machine learning-ready data.
...
Use the GCP console, [gcloud CLI](https://cloud.google.com/cli), or API to create a bucket:
